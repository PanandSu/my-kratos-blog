...
const (
	Blog_CreateBlog_FullMethodName             = "/api.Blog/CreateBlog"
	Blog_UpdateBlog_FullMethodName             = "/api.Blog/UpdateBlog"
	Blog_UpdateIndividualFields_FullMethodName = "/api.Blog/UpdateIndividualFields"
	Blog_DeleteBlog_FullMethodName             = "/api.Blog/DeleteBlog"
	Blog_GetBlogByTag_FullMethodName           = "/api.Blog/GetBlogByTag"
	Blog_ListBlog_FullMethodName               = "/api.Blog/ListBlog"
	Blog_GetBlogByID_FullMethodName            = "/api.Blog/GetBlogByID"
	Blog_GetBlogByTitle_FullMethodName         = "/api.Blog/GetBlogByTitle"
	Blog_UpdateOnly_FullMethodName             = "/api.Blog/UpdateOnly"
	Blog_CacheBlog_FullMethodName              = "/api.Blog/CacheBlog"
	Blog_GetCacheBlog_FullMethodName           = "/api.Blog/GetCacheBlog"
	Blog_DeleteCacheBlog_FullMethodName        = "/api.Blog/DeleteCacheBlog"
	Blog_AddSuggestBlog_FullMethodName         = "/api.Blog/AddSuggestBlog"
	Blog_DeleteSuggestBlog_FullMethodName      = "/api.Blog/DeleteSuggestBlog"
	Blog_GetAllSuggest_FullMethodName          = "/api.Blog/GetAllSuggest"
	Blog_UpdateBlogVisit_FullMethodName        = "/api.Blog/UpdateBlogVisit"
	Blog_GetCommentPower_FullMethodName        = "/api.Blog/GetCommentPower"
)
