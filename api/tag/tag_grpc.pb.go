...
const (
	Tag_CreateTag_FullMethodName = "/api.Tag/CreateTag"
	Tag_DeleteTag_FullMethodName = "/api.Tag/DeleteTag"
	Tag_ListTag_FullMethodName   = "/api.Tag/ListTag"
)
